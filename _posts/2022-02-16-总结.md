...
1.自我介绍范文（仅供参考）
Good morning/afternoon/evening, my name is wangfengquan. I’m 24 years old. I came from weifang city of shandong province.
I graduated from shandong University of JiNingUniversity in 2020. My major is computer science and technology. I have large enthusiasm in programming. I learned very hard and learned Java by myself during the college.
After graduate, I found a job in a  QingDao IT company. I have worked in this company for one years. I can mastered the mainstream developing technology such as Spring, SpringBoot,SpringClould, Spring MVC, Mybatis, I also can use the database like MYSQL; For the front end, jQuery framework such as Easy UI and Bootstrap was also involved in my work.
...
![image-20220218223156339](C:\Users\WFQ\AppData\Roaming\Typora\typora-user-images\image-20220218223156339.png)
